<?php
/**
 * Widget: RSM Social Channels
 * Ver: 1.0
 *
 * NOTE: These ACF widget fields aren't currently compatible with page builders.
 */

class RSM_SocialChannels_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      'rsm_SocialChannels_widget', // Base ID
      __('RSM - Social Channels', 'text_domain'), // Name
  ...
  public function widget( $args, $instance ) {
     ...
     *
     */
    $custom_class = get_field('rsm_widget_social_channels_custom_class', 'widget_' . $args['widget_id']);
    ...
    rsm_get_template( 'rsm-social-networks.php', $widget_args );
...
} // class RSM_SocialChannels_Widget

// register RSM_SocialChannels_Widget widget
add_action( 'widgets_init', function(){
  register_widget( 'RSM_SocialChannels_Widget' );
});