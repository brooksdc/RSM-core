...
<header role="banner" class="site-header header-layout-3" id="masthead">
		...
		<div class="<?php _e($header_container_class); ?>">
			...
			<div class="display-table">
				...
				<nav class="site-header__navigation" role="navigation" >
					...
					<?php echo do_shortcode('[rsm_social_networks]'); ?>
			...
			<?php
			/*
			 MOBILE MENU. (Custom for quantus CMI)
			 */
			?>
			<div class="site-header__mobile-nav">
				<button href="#" class="site-header__mobile-nav__toggle btn btn--menu"><span class="bar"></span><span class="bar"></span><span class="bar"></span></button>
				<div class="site-header__mobile-nav__dropdown">
					<?php echo do_shortcode('[rsm_social_networks]'); ?>
					<?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'mobile-primary', 'menu_class' => 'menu', 'container' => false, 'fallback_cb' => false ) ); ?>
				</div>
			</div>
...
if(!function_exists('initialize_header_3_inline_function')):
function initialize_header_3_inline_function() { ?>
...
add_action('wp_footer', 'initialize_header_3_inline_function', 20);
